...
We have identified ten high-level design principles that will make your application more scalable, resilient, and manageable, such as "minimize coordination" and "make all things redundant." 
...
A successful cloud application will focus on five pillars of software quality: Scalability, availability, resiliency, management, and security.
...
A design pattern is general solution to a common problem. The idea of [software design patterns](https://wikipedia.org/wiki/Software_design_pattern) was popularized in the book *Design Patterns: Elements of Reusable Object-Oriented Software* (Gamma et al). We have identified a set of design patterns that are especially useful when designing distributed applications for the cloud.
